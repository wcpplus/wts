	...
	<div data-options="region:'center'">
		<form id="dom_formSubjectanswer">
			...
			<table class="editTable">
				...
				<tr>
					<td class="title"></td>
					<td colspan="3" style="color: #999;font-size: 12px;">用符号 “|”隔开代表同义词,如：清晨|早晨|朝晨,同义词均可得分</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="title"></td>
					<td colspan="3" style="color: #999;font-size: 12px;">1.满足该项答案，获得的得分权重，最终总权重为各项答案权重累计之和<br />2.权重并非得分，而是所占得分的比重</td>
				</tr>
			</table>
		</form>
	</div>
