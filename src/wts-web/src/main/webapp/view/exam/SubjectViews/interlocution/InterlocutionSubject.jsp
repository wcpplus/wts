...
<div class="easyui-layout" data-options="fit:true">
	<div
		data-options="region:'east',iconCls:'icon-comment',collapsible:false,title:'问答题答案关键词'"
		style="width: 450px;">
		<table id="dataSubjectanswerGrid">
			<thead>
				<tr>
					...
					<th field="ANSWER" data-options="sortable:true" width="80">答案关键字</th>
...
<script type="text/javascript">
	...
	var title_windowSubjectanswer = "题答案管理";//功能名称
