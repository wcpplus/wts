...
<div id="timeNavButtonId" class="warnTimeTip" >
	<div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="wts-sidecard"
					style="width: 100%; margin-top: 0px; padding-bottom: 20px;">
					<div
						style="border-bottom: 1px dashed #ccc; padding-bottom: 20px; margin-bottom: 20px;">
						<div class="btn-group btn-group-justified wts-sidecard-buttons"
							...
							<div class="btn wts-countdown-title" title="以服务器时间为准">
								开始答题
								<PF:FormatTime date="${card.starttime}"
