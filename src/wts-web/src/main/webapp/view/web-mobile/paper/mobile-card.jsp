...
<title>移动答题卡- <PF:ParameterValue key="config.sys.title" /></title>
...
<link href="view/web-mobile/paper/text/mobile-card.css" rel="stylesheet">
</head>
<body>
	...
	<div class="containerbox">
		<div
			...
			<div class="container" style="padding: 0px;">
					...
					<div class="wts-paper-forms">
						<c:forEach items="${paper.chapters}" var="chapter1">
							<div class="chapterBox-mobile">
								...
								<%@ include
									file="/view/web-simple/paper/commons/IncludeLeve1Subjects.jsp"%>
								<c:forEach items="${chapter1.chapters}" var="chapter2">
									...
									<%@ include
										file="/view/web-simple/paper/commons/IncludeLeve2Subjects.jsp"%>
									<c:forEach items="${chapter2.chapters}" var="chapter3">
										...
										<%@ include
											file="/view/web-simple/paper/commons/IncludeLeve3Subjects.jsp"%>
									</c:forEach>
								</c:forEach>
							</div>
						</c:forEach>
				...
				<div>
					<jsp:include
						page="/view/web-mobile/paper/commons/IncludeSideCard.jsp"></jsp:include>
				</div>
			</div>
		</div>
	</div>
