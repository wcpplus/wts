 ...
 *说明：
 */
public interface RandomStepDaoInter  {
 /** 删除一个答卷随机步骤实体
 * @param entity 实体
 */
 public void deleteEntity(RandomStep randomstep) ;
 /** 由答卷随机步骤id获得一个答卷随机步骤实体
 * @param id
 * @return
 */
 ...
 */
 ...
 /**
 * 条件删除答卷随机步骤实体，依据对象字段值(一般不建议使用该方法)
 * 
 * @param rules
 *            删除条件
 */
 ...
 /**
 * 条件查询答卷随机步骤实体，依据对象字段值,当rules为空时查询全部(一般不建议使用该方法)
 * 
 * @param rules
 *            查询条件
 * @return
 */
 ...
 /**
 * 条件修改答卷随机步骤实体，依据对象字段值(一般不建议使用该方法)
 * 
 * @param values
 *            被修改的键值对
 * @param rules
