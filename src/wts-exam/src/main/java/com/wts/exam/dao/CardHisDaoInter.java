 ...
 *说明：
 */
public interface CardHisDaoInter  {
 /** 删除一个答题卡历史记录实体
 * @param entity 实体
 */
 public void deleteEntity(CardHis cardhis) ;
 /** 由答题卡历史记录id获得一个答题卡历史记录实体
 * @param id
 * @return
 */
 ...
 */
 ...
 /**
 * 条件删除答题卡历史记录实体，依据对象字段值(一般不建议使用该方法)
 * 
 * @param rules
 *            删除条件
 */
 ...
 /**
 * 条件查询答题卡历史记录实体，依据对象字段值,当rules为空时查询全部(一般不建议使用该方法)
 * 
 * @param rules
 *            查询条件
 * @return
 */
 ...
 /**
 * 条件修改答题卡历史记录实体，依据对象字段值(一般不建议使用该方法)
 * 
 * @param values
 *            被修改的键值对
 * @param rules
